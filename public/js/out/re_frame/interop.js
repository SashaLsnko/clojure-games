...
return [(function (){var pred__22484 = cljs.core.instance_QMARK_;
var expr__22485 = reactive_val;
if(cljs.core.truth_(pred__22484.call(null,reagent.ratom.RAtom,expr__22485))){
return "ra";
} else {
if(cljs.core.truth_(pred__22484.call(null,reagent.ratom.RCursor,expr__22485))){
return "rc";
} else {
if(cljs.core.truth_(pred__22484.call(null,reagent.ratom.Reaction,expr__22485))){
return "rx";
} else {
if(cljs.core.truth_(pred__22484.call(null,reagent.ratom.Track,expr__22485))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1572229098549
