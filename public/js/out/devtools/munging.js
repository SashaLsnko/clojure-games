...
var o24398 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24398["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24399 = temp__5718__auto____$1;
return (o24399["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23508__auto__ = f;
return (o__23508__auto__["toString"]).call(o__23508__auto__);
} else {
return "";
}
}catch (e24400){var _ = e24400;
return "";
}});
...
try{var o__23508__auto___24402 = t;
(o__23508__auto___24402["cljs$lang$ctorPrWriter"]).call(o__23508__auto___24402,t,writer);
}catch (e24401){var __24403 = e24401;
}
...
var char_code = (function (){var o__23508__auto__ = (new String(char$));
return (o__23508__auto__["charCodeAt"]).call(o__23508__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23508__auto__ = String;
return (o__23508__auto__["fromCharCode"]).call(o__23508__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24404 = num_code;
switch (G__24404) {
case (1):
return (185);
...
var o__23508__auto__ = String;
return (o__23508__auto__["fromCharCode"]).call(o__23508__auto__,superscript_code);
});
/**
...
}catch (e24406){var _e__23515__auto__ = e24406;
return false;
}})())){
...
var vec__24407 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24407,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o24410 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24410["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24411 = temp__5718__auto____$1;
return (o24411["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___24418 = arguments.length;
var i__4731__auto___24419 = (0);
while(true){
if((i__4731__auto___24419 < len__4730__auto___24418)){
args__4736__auto__.push((arguments[i__4731__auto___24419]));

var G__24420 = (i__4731__auto___24419 + (1));
i__4731__auto___24419 = G__24420;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24414){
var vec__24415 = p__24414;
var ns_detector = cljs.core.nth.call(null,vec__24415,(0),null);
...
var G__24421 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24422 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24421;
remaining_tokens = G__24422;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24412){
var G__24413 = cljs.core.first.call(null,seq24412);
var seq24412__$1 = cljs.core.next.call(null,seq24412);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24413,seq24412__$1);
});
...
var vec__24426 = cljs.core.split_with.call(null,(function (p1__24425_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24425_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24426,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24426,(1),null);
...
var vec__24432 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24432,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24432,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24435 = cljs.core.rest.call(null,remaining_tokens);
var G__24436 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24435;
name_tokens = G__24436;
continue;
} else {
...
var vec__24439 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24439,(0),null);
var arity = cljs.core.nth.call(null,vec__24439,(1),null);
var vec__24442 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24442,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24442,(1),null);
var vec__24445 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24445,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24445,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24445,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24445,(3),null);
...
var vec__24451 = result;
var munged_ns = cljs.core.nth.call(null,vec__24451,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24451,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24451,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24451,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24451,(4),null);
var arity = cljs.core.nth.call(null,vec__24451,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__24455 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__24455,(0),null);
var args = cljs.core.nth.call(null,vec__24455,(1),null);
var vec__24458 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24458,(0),null);
var name = cljs.core.nth.call(null,vec__24458,(1),null);
...
var G__24461 = (arity + (1));
var G__24462 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24463){
var vec__24464 = p__24463;
var arity = cljs.core.nth.call(null,vec__24464,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24464,(1),null);
...
return cljs.core.get.call(null,arities,p1__24467_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24468_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___24475 = arguments.length;
var i__4731__auto___24476 = (0);
while(true){
if((i__4731__auto___24476 < len__4730__auto___24475)){
args__4736__auto__.push((arguments[i__4731__auto___24476]));

var G__24477 = (i__4731__auto___24476 + (1));
i__4731__auto___24476 = G__24477;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24471){
var vec__24472 = p__24471;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24472,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24469){
var G__24470 = cljs.core.first.call(null,seq24469);
var seq24469__$1 = cljs.core.next.call(null,seq24469);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24470,seq24469__$1);
});
...
var map__24480 = options;
var map__24480__$1 = (((((!((map__24480 == null))))?(((((map__24480.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24480.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24480):map__24480);
var include_ns_QMARK_ = cljs.core.get.call(null,map__24480__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24480__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24480__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24480__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24481 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24481,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24481,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24481,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24481,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24481,(4),null);
var arity = cljs.core.nth.call(null,vec__24481,(5),null);
...
var o__23508__auto__ = f;
return (o__23508__auto__["getBasis"]).call(o__23508__auto__);
});
/**
...
}catch (e24485){var _e__23515__auto__ = e24485;
...
var G__24486 = (obj[cljs.core.first.call(null,path)]);
var G__24487 = cljs.core.rest.call(null,path);
obj = G__24486;
path = G__24487;
continue;
} else {
...
return (function (accum,p__24488){
var vec__24489 = p__24488;
var bit = cljs.core.nth.call(null,vec__24489,(0),null);
var protocol = cljs.core.nth.call(null,vec__24489,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24492){
var vec__24493 = p__24492;
var ns = cljs.core.nth.call(null,vec__24493,(0),null);
var name = cljs.core.nth.call(null,vec__24493,(1),null);
var selector = cljs.core.nth.call(null,vec__24493,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24498,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24498,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24498,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24496_SHARP_){
return (obj[cljs.core.first.call(null,p1__24496_SHARP_)]);
});})(name,sorted_matches,vec__24498,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1572229100912
