...
return (new CustomEvent(event_name,(function (){var obj30389 = ({"detail":data});
return obj30389;
})()));
} else {
...
var f = (function (){var pred__30396 = cljs.core._EQ_;
var expr__30397 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30396.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30397))){
return ((function (pred__30396,expr__30397){
return (function (p1__30390_SHARP_){
return console.warn(p1__30390_SHARP_);
});
;})(pred__30396,expr__30397))
} else {
if(cljs.core.truth_(pred__30396.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30397))){
return ((function (pred__30396,expr__30397){
return (function (p1__30391_SHARP_){
return console.debug(p1__30391_SHARP_);
});
;})(pred__30396,expr__30397))
} else {
if(cljs.core.truth_(pred__30396.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30397))){
return ((function (pred__30396,expr__30397){
return (function (p1__30392_SHARP_){
return console.error(p1__30392_SHARP_);
});
;})(pred__30396,expr__30397))
} else {
return ((function (pred__30396,expr__30397){
return (function (p1__30393_SHARP_){
return console.log(p1__30393_SHARP_);
});
;})(pred__30396,expr__30397))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30400){
...
var opts = map__30401__$1;
var eval_fn = cljs.core.get.call(null,map__30401__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30403_SHARP_);
});})(new_def))
);
...
return (function (p__30404){
var vec__30405 = p__30404;
var ky = cljs.core.nth.call(null,vec__30405,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1572229110234
