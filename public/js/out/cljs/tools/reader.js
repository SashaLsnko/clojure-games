...
var G__26801 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26801;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26802 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26802,ch);
...
if(("\\" === ch__$1)){
var ch_26803__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26803__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26803__$2);
} else {
}

var G__26804 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26804;
continue;
}
}
...
var vec__26812 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26812,(0),null);
var start_column = cljs.core.nth.call(null,vec__26812,(1),null);
...
var G__26815 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26815;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26816 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26817 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26817;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26816;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26818 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26818,(0),null);
var start_column = cljs.core.nth.call(null,vec__26818,(1),null);
...
var vec__26821 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26821,(0),null);
var end_column = cljs.core.nth.call(null,vec__26821,(1),null);
...
var vec__26824 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26824,(0),null);
var start_column = cljs.core.nth.call(null,vec__26824,(1),null);
...
var vec__26827 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26827,(0),null);
var end_column = cljs.core.nth.call(null,vec__26827,(1),null);
...
var vec__26830 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26830,(0),null);
var start_column = cljs.core.nth.call(null,vec__26830,(1),null);
...
var vec__26833 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26833,(0),null);
var end_column = cljs.core.nth.call(null,vec__26833,(1),null);
...
var sb = (function (){var G__26836 = (new goog.string.StringBuffer());
...
var G__26838 = (function (){var G__26837 = sb;
G__26837.append(ch);

return G__26837;
})();
var G__26839 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26838;
ch = G__26839;
continue;
}
...
switch (G__26842) {
case "\\":
var G__26846 = (function (){var G__26843 = sb;
G__26843.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26843;
})();
var G__26847 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26846;
ch = G__26847;
continue;
...
break;
default:
var G__26848 = (function (){var G__26844 = sb;
G__26844.append(ch);

return G__26844;
})();
var G__26849 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26848;
ch = G__26849;
continue;
...
var vec__26850 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26850,(0),null);
var end_column = cljs.core.nth.call(null,vec__26850,(1),null);
...
var vec__26853 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26853,(0),null);
var column = cljs.core.nth.call(null,vec__26853,(1),null);
...
var vec__26858 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26858,(0),null);
var column = cljs.core.nth.call(null,vec__26858,(1),null);
...
var vec__26863 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26863,(0),null);
var column = cljs.core.nth.call(null,vec__26863,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__26874 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26874,true,null,opts,pending_forms);
...
var G__26875 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26875)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26875)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26875)){
...
var _STAR_suppress_read_STAR__orig_val__26876 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26877 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26877;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26876;
}});
...
var G__26878 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26878,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26878,rdr,first_line);
...
var G__26882 = matched;
var G__26883 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26882;
finished = G__26883;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__26884 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26885 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26885;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26884;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__26886 = cljs.tools.reader.arg_env;
var arg_env_temp_val__26887 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__26887;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26888 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26888,"(");
...
var G__26889 = (i + (1));
var G__26890 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__26886;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26891 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26891);
...
var G__26892 = cljs.core.next.call(null,s__$1);
var G__26893 = ret;
s__$1 = G__26892;
r = G__26893;
continue;
...
var G__26894 = cljs.core.next.call(null,s);
var G__26895 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26894;
key_vals = G__26895;
continue;
} else {
...
var gensym_env_orig_val__26899 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26900 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__26900;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__26899;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26901 = token;
var G__26901__$1 = (((G__26901 == null))?null:cljs.core.subs.call(null,G__26901,(1)));
var G__26901__$2 = (((G__26901__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26901__$1));
var G__26901__$3 = (((G__26901__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26901__$2));
var G__26901__$4 = (((G__26901__$3 == null))?null:cljs.core.symbol.call(null,G__26901__$3));
if((G__26901__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26901__$4);
}
})():(function (){var G__26902 = token;
var G__26902__$1 = (((G__26902 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26902));
if((G__26902__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26902__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26913,reader){
...
var eof = cljs.core.get.call(null,map__26914__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___26922 = arguments.length;
var i__4731__auto___26923 = (0);
while(true){
if((i__4731__auto___26923 < len__4730__auto___26922)){
args__4736__auto__.push((arguments[i__4731__auto___26923]));

var G__26924 = (i__4731__auto___26923 + (1));
i__4731__auto___26923 = G__26924;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26920){
var G__26921 = cljs.core.first.call(null,seq26920);
var seq26920__$1 = cljs.core.next.call(null,seq26920);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26921,seq26920__$1);
});


//# sourceMappingURL=reader.js.map?rel=1572229107474
